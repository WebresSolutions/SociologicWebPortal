...
public partial class VwGetRatiosAggregatedAllYearsLgacopy
{
    ...
    public decimal ExistingUnits { get; set; }

    public double? ActualRatio { get; set; }

    public double? WholeReq { get; set; }

    public int RemainderReq { get; set; }
}
